      ...
      <nav className="w-4/5 bg-zinc-600 bg-opacity-50 rounded-3xl z-[99] backdrop-blur-[10px] fixed top-3 left-1/2 -translate-x-1/2 ">
        <div className="flex flex-wrap items-center justify-around">
          <div className="p-3 text-4xl cursor-pointer font-bold tracking-wide">
            <a href="#">
              STONK<span className="text-sky-400">S</span>
            </a>
          </div>
          {windowWidth > 550 ? (
            <div className="p-5">
              <ul className="flex flex-wrap list-none gap-10 font-semibold uppercase">
                <li className="text-xl cursor-pointer group hover:text-sky-400">
                  <a href="#">Home</a>
                  <span class="block max-w-0 group-hover:max-w-full transition-all duration-300 h-0.5 bg-sky-400"></span>
                </li>
                <li className="text-xl cursor-pointer group hover:text-sky-400">
                <a href="https://github.com/Soham-Chaudhuri/Stock-Price-Predictor-2.0/blob/main/big_tech_companies.csv" target="_blank" rel="noopener noreferrer">Companies</a>
                  <span class="block max-w-0 group-hover:max-w-full transition-all duration-300 h-0.5 bg-sky-400"></span>
                </li>
                <li className="text-xl cursor-pointer group hover:text-sky-400">
                <a href="https://github.com/Soham-Chaudhuri/Stock-Price-Predictor-2.0" target="_blank" rel="noopener noreferrer">GitHub</a>
                  <span class="block max-w-0 group-hover:max-w-full transition-all duration-300 h-0.5 bg-sky-400"></span>
                </li>
                <li className="text-xl cursor-pointer group hover:text-sky-400">
                  <a href="#">About</a>
